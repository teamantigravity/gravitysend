...
class AdIds {
  ...
  // Hardcoded to false to ALWAYS serve real ads per user request.
  // Warning: Clicking your own live ads during development can lead to AdMob account suspension.

...
class _Translations$receiveOptionsPage$et extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(GravitySendi kaust)';
  @override
...
class _Translations$webSharePage$et extends Translations$webSharePage$en {
  ...
  String get encryptionHint =>
      'GravitySend kasutab enda poolt allkirjastatud sertifikaate. Ühenduse toimimiseks palun nõustu nendega veebibrauseris.';
  @override
...
class _Translations$aboutPage$et extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Rakenduse teave: GravitySend';
  @override
  List<String> get description => [
    'GravitySend põhineb avatud lähtekoodil, on kõikide jaoks vaba ning tasuta kasutatav. Rakenduse eesmärgiks on võimaldada failide ja tekstide jagamist kohtvõrgus asuvate arvutite vahel nii, et välist internetiühendust pole vaja kasutada.',
...
class _Translations$donationPage$et extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'GravitySend põhineb avatud lähtekoodil, on kõikide jaoks vaba ning tasuta kasutatav, ega sisalda reklaame. Kui sulle see rakendus meeldib, siis palun toeta meie arendust.';
  @override
...
class _Translations$tray$et extends Translations$tray$en {
  ...
  @override
  String get close => 'Sulge GravitySend';
  @override
...
class _Translations$networkInterfacesPage$et extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Vaikimisi kasutab GravitySend kõiki võrguliideseid. Kui sul on vaja, siis saad mittesoovitud võrgud siinkohal välistada ning muudatuste jõustumine eeldab serverikomponendi uuesti käivitamist.';
}
...
class _Translations$settingsTab$general$et extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Näita GravitySendi kontekstimenüüs';
  @override
...
class _Translations$settingsTab$other$et extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Toeta GravitySendi';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$et extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Ilma kohtvõrgu skaneerimise õiguseta ei suuda GravitySend leida teisi seadmeid. Palun luba süsteemi seadistustest vajalikud õigused.';
  @override
...
class _Translations$dialogs$sendModeHelp$et extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Kui failide vastuvõtjatel pole arvutis või nutiseadmes rakendust GravitySend, siis avades etteantud lingi oma veebibrauseris, saavad nad failid alla laadida.';
}

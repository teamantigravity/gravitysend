...
class _Translations$receiveOptionsPage$it extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(cartella GravitySend)';
  @override
...
class _Translations$webSharePage$it extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'GravitySend utilizza un certificato autofirmato. Devi accettarlo nel browser.';
  @override
...
class _Translations$aboutPage$it extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Informazioni su GravitySend';
  @override
  List<String> get description => [
    'GravitySend è un\'app gratuita e open-source che consente di condividere file e messaggi in modo sicuro con dispositivi vicini sulla tua rete locale, senza bisogno di una connessione internet.',
...
class _Translations$donationPage$it extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'GravitySend è gratuito, open-source e privo di pubblicità. Se ti piace l\'applicazione, puoi supportarne lo sviluppo con una donazione.';
  @override
...
class _Translations$tray$it extends Translations$tray$en {
  ...
  @override
  String get close => 'Esci da GravitySend';
  @override
...
class _Translations$networkInterfacesPage$it extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Per impostazione predefinita, GravitySend utilizza tutte le interfacce di rete disponibili. È possibile escludere le reti indesiderate. È necessario riavviare il server per applicare le modifiche.';
  @override
  String get preview => 'Anteprima';
  @override
...
class _Translations$settingsTab$general$it extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostra GravitySend nel menù contestuale';
  @override
...
class _Translations$settingsTab$other$it extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Supporta GravitySend';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$it extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'GravitySend non può trovare altri dispositivi senza il permesso per la scansione della rete locale. Puoi concedere questo permesso nelle impostazioni.';
  @override
...
class _Translations$dialogs$sendModeHelp$it extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'I destinatari che non hanno installato GravitySend possono scaricare i file selezionati aprendo il link nel loro browser.';
}

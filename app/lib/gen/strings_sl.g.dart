...
class _Translations$receiveOptionsPage$sl extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(mapa GravitySend)';
  @override
...
class _Translations$webSharePage$sl extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'GravitySend uporablja samopodpisano potrdilo. Sprejeti ga morate v svojem brskalniku.';
  @override
...
class _Translations$aboutPage$sl extends Translations$aboutPage$en {
  ...
  List<String> get description => [
    'GravitySend je brezplačna, odprtokodna aplikacija, ki vam omogoča varno deljenje datotek in sporočil z napravami v bližini prek lokalnega omrežja brez potrebe po internetni povezavi.',
...
class _Translations$donationPage$sl extends Translations$donationPage$en {
  ...
  @override
  String get info => 'GravitySend je brezplačna, odprtokodna in brez oglasov. Če vam je aplikacija všeč, lahko podprete razvoj z donacijo.';
  @override
...
class _Translations$tray$sl extends Translations$tray$en {
  ...
  @override
  String get close => 'Zapri GravitySend';
  @override
...
class _Translations$settingsTab$general$sl extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Prikaži GravitySend v kontekstnem meniju';
  @override
...
class _Translations$settingsTab$other$sl extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Podprite GravitySend';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$sl extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'GravitySend ne more najti drugih naprav brez dovoljenja za iskanje v lokalnem omrežju. Prosim, omogočite to dovoljenje v nastavitvah.';
  @override
...
class _Translations$dialogs$sendModeHelp$sl extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Prejemniki, ki nimajo nameščenega GravitySend, lahko prenesejo izbrane datoteke z odpiranjem povezave v brskalniku.';
}

...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, GravitySend uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, GravitySend uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$receiveOptionsPage$en {
  ...
  /// en: '(GravitySend folder)'
  String get appDirectory => '(GravitySend folder)';
...
class Translations$webSharePage$en {
  ...
  /// en: 'GravitySend uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'GravitySend uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$donationPage$en {
  ...
  /// en: 'GravitySend is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'GravitySend is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$tray$en {
  ...
  /// en: 'Quit GravitySend'
  String get close => 'Quit GravitySend';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show GravitySend in context menu'
  String get showInContextMenu => 'Show GravitySend in context menu';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'GravitySend can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'GravitySend can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have GravitySend installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have GravitySend installed can download the selected files by opening the link in their browser.';
}

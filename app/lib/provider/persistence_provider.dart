...
import 'package:gravitysend_app/model/persistence/receive_history_entry.dart';
...
import 'package:gravitysend_app/util/security_helper.dart';
import 'package:gravitysend_app/util/shared_preferences/shared_preferences_file.dart';
import 'package:gravitysend_app/util/shared_preferences/shared_preferences_portable.dart';
import 'package:gravitysend_app/util/ui/animations_status.dart';
...
String get _windowsFile {
  ...
  return '$appData\\GravitySend\\settings.json';
}

String get _windowsLegacyFile {
  final appData = Platform.environment['APPDATA'];
  return '$appData\\com.gravitysend.app\\shared_preferences.json';
}

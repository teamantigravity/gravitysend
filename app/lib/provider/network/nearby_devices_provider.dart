...
import 'package:gravitysend_app/model/state/nearby_devices_state.dart';
...
/// - Scanning the network for other GravitySend instances
...
/// It just sends an announcement which will cause a response on every other GravitySend member of the network.

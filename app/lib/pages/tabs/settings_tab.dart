...
import 'package:gravitysend_app/widget/dialogs/quick_save_from_favorites_notice.dart';
import 'package:gravitysend_app/widget/dialogs/quick_save_notice.dart';
import 'package:gravitysend_app/widget/dialogs/text_field_tv.dart';
import 'package:gravitysend_app/widget/dialogs/text_field_with_actions.dart';
                  ...
                  _SettingsSection(
                    ...
                    children: [
                      ...
                      if (checkPlatformIsDesktop()) ...[
                        /// Wayland does window position handling, so there's no need for it. See [https://github.com/gravitysend/app/issues/544]
                    ...
                    children: [
                      if (checkPlatform([TargetPlatform.android, TargetPlatform.iOS]) && !AdManager.isAdFree)
                        _ButtonEntry(
                          ...
                          onTap: () async {
                            await context.push(() => const UpgradePage());
                          },
                        ),
                       _ButtonEntry(

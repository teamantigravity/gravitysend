...
import 'package:gravitysend_app/util/native/open_file.dart';
import 'package:gravitysend_app/util/native/open_folder.dart';
import 'package:gravitysend_app/util/native/platform_check.dart';
import 'package:gravitysend_app/util/native/taskbar_helper.dart';
...
import 'package:gravitysend_app/widget/custom_progress_bar.dart';
import 'package:gravitysend_app/widget/dialogs/cancel_session_dialog.dart';
import 'package:gravitysend_app/widget/dialogs/error_dialog.dart';
...
class _ProgressPageState extends State<ProgressPage> with Refena {
  ...
  Future<void> _maybeAskForReview() async {
    ...
    final count = (prefs.getInt('gs_transfer_count') ?? 0) + 1;
    await prefs.setInt('gs_transfer_count', count);
    // Ask for review after 5th successful transfer
    if (count == 5) {
